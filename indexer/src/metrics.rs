    ...
    match event {
        AnyEvent::Torch(e) => (
            ...
            match e {
                ...
                TorchEvent::LoanCreated(_) => "loan_created",
                TorchEvent::LoanRepaid(_) => "loan_repaid",
                TorchEvent::LoanLiquidated(_) => "loan_liquidated",
                TorchEvent::ShortOpened(_) => "short_opened",
                TorchEvent::ShortClosed(_) => "short_closed",
                TorchEvent::ShortLiquidated(_) => "short_liquidated",
