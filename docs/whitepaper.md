...
72 Kani proof harnesses. 33 proptest properties (5,000 random cases each). 100 litesvm integration tests. All passing. Cross-validated by independent audit (Claude Opus 4.7).
